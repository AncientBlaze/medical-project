...
const ThemeToggle = ({ theme, toggle, className = '' }) => (
  <button onClick={toggle}
    className={`flex items-center justify-center w-8 h-8 rounded-lg transition-colors bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-[#2d409c] dark:text-slate-400 hover:text-[#2d409c] dark:hover:text-slate-300 ${className}`}
  >
    ...
    <div className="sticky top-0 z-20 border-b backdrop-blur-sm transition-colors duration-300 border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-950/90">
      <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-sm tracking-tight text-[#2d409c] dark:text-white">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-medium transition-colors bg-slate-100 dark:bg-slate-900/40 hover:bg-slate-200 dark:hover:bg-slate-900/60 border-slate-200 dark:border-slate-800 text-[#2d409c] dark:text-slate-400 hover:text-[#2d409c] dark:hover:text-slate-300"
          >
