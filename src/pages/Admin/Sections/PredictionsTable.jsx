  ...
  return (
    <div className="rounded-2xl overflow-hidden border bg-white dark:bg-slate-900/40 border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none">
      ...
      <div className="flex items-center gap-4 px-6 py-4 border-b border-slate-200 dark:border-slate-800">
        <h2 className="text-sm font-semibold shrink-0 text-[#2d409c] dark:text-white">
          All Predictions
        </h2>
        <div className="relative flex-1 max-w-xs ml-auto">
          ...
          <input type="text" placeholder="Search…" value={query}
            ...
            className="w-full pl-9 pr-4 py-2 rounded-lg text-sm focus:outline-none transition-colors border bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-[#2d409c] dark:text-white placeholder-slate-400 focus:border-amber-400 dark:focus:border-teal-400" />
        </div>
                ...
                <tr key={l._id} className="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/30">
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <p className="font-medium text-[#2d409c] dark:text-white">
                          {l.user?.name || 'Guest'}
                        </p>
                  ...
                  {/* Category */}
                  <td className="px-5 py-3.5">
                    <span className="px-2.5 py-1 rounded-lg border text-xs bg-slate-100 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-[#2d409c] dark:text-slate-400">
                      {l.category}
                    </span>
                  </td>
                  ...
                  <td className="px-5 py-3.5">
                    {l.phone ? (
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs whitespace-nowrap text-[#2d409c] dark:text-slate-400">
                          {l.phone}
                        </span>
                      </div>
                    ) : (
